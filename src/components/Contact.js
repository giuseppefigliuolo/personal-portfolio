...
import linkedInLogo from "../imgs/logos/social/orange-linkedin.svg";
import instagramLogo from "../imgs/logos/social/orange-instagram.svg";
    ...
    <div id="contact" className="contact" ref={ref}>
      <div className="contact__header">
        ...
        <div className="email-btn">
          <CallToAction text="figliuologiuseppe@gmail.com" />
        </div>
      </div>
      <motion.div
